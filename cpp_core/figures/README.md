...
| `unified_4x3_dy_accel_jerk.png` | cached dy (4:3) + validate CSVs | unified matched-4:3: 4 clips × {default, DCR, L1 box12} vs DJI — L1 wins 3/4 incl. calm, DCR wins the most violent; §8m |
